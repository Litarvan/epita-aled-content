...
Exemple : pour définir votre fond d'écran, rajoutez une ligne `exec_always feh --bg-scale chemin/complet/du/fond/d'écran`, puis faites `mod+Shift+R` et il devrait apparaître !
